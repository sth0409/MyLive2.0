...
//    }
    ...
    public void setUiWitStateAndScreen(int state) {
        currentState = state;
        Log.i(TAG, "setUiWitStateAndScreen: ---"+state);
        switch (currentState) {
    ...
    public void onAutoCompletion() {
      //  Toast.makeText(getContext(), "666", Toast.LENGTH_SHORT).show();
        Log.i(TAG, "onAutoCompletion " + " [" + this.hashCode() + "] ");
            ...
            OnPlayerEndListenier.PlayerEndEnvent();

        onEvent(JCBuriedPoint.ON_AUTO_COMPLETE);
        JCVideoPlayerManager.completeAll();
    }

    public interface OnPlayerEndListenier {
        void PlayerEndEnvent();
    }

    OnPlayerEndListenier OnPlayerEndListenier = null;

    public void setOnPlayerEndListenier(OnPlayerEndListenier e) {
        OnPlayerEndListenier = e;
    }
    @Override
...
//                .findViewById(Window.ID_ANDROID_CONTENT);
        ...
        try {
            ...
            jcVideoPlayer.setOnPlayerEndListenier(OnPlayerEndListenier);
