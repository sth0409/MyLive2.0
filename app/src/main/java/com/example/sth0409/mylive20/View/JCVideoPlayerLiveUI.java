package com.example.sth0409.mylive20.View;
...
/**
 * Created by STH0409 on 2016/10/20.
 */

public class JCVideoPlayerLiveUI extends JCVideoPlayer {
    ...
    protected JCVideoPlayerLiveUI.DismissControlViewTimerTask mDismissControlViewTimerTask;


    public JCVideoPlayerLiveUI(Context context) {
        super(context);

    }

    public JCVideoPlayerLiveUI(Context context, AttributeSet attrs) {
...
//                    }
    ...
    public void refreshCache() {
        if (pauseSwitchCoverBitmap != null) {
            JCVideoPlayerLiveUI jcVideoPlayer = ((JCVideoPlayerLiveUI) JCVideoPlayerManager.getFirst());
